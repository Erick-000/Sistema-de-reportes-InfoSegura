  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?php echo $URL; ?>" class="brand-link">
        <img src="<?php echo $URL; ?>/public/images/_dfc39567-7c5a-4fa3-97a2-71f5aeabfad6.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">InfoSegura</span>
      </a>
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo $URL; ?>/reportes/create.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Publicar reportes</p>
                </a>
              </li>
            </ul>
          </li>
